...
export default {
  ...
  addSubscriptions() {
    ...
    this.subscriptions.add(
      atom.commands.add(
        'atom-workspace', {
          'cacher:findSnippet': {
            didDispatch: () => { console.log('find snippet'); },
            displayName: 'Cacher: Find Snippet',
            description: 'Find a snippet to insert or open in Cacher'
          }
        }
      )
    );
  ...
  deactivate() {
    ...
    this.snippetsService.deactivate();
    this.setupController.deactive();
  },
