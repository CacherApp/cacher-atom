...
import FindSnippetController from './controllers/find-snippet.controller';
import CreateSnippetController from './controllers/create-snippet.controller';
...
export default {
  ...
  activate(state) {
    ...
    this.createSnippetController = new CreateSnippetController(
      this.setupController,
      this.snippetsService
    );
  ...
  addSubscriptions() {
    ...
    this.subscriptions.add(
      atom.commands.add(
        'atom-workspace', {
          'cacher:findSnippet': {
            didDispatch: () => {
              this.findSnippetController.initialize();
            },
      ...
      atom.commands.add(
        'atom-workspace', {
          'cacher:createSnippet': {
            didDispatch: () => {
              this.createSnippetController.initialize();
            },
    ...
    this.subscriptions.add(
      atom.commands.add(
        ...
        'cacher:setup': {
          didDispatch: () => {
            this.setupController.showCredentialsView();
          },
    ...
    this.subscriptions.add(
      atom.commands.add('atom-workspace', {
        'cacher:refresh': {
          didDispatch: () => {
            this.snippetsService.fetchSnippets();
          },
  ...
  deactivate() {
    ...
    this.createSnippetController.dispose();
  }
};
